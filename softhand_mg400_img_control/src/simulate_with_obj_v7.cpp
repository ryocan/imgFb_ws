...
// path
int segment_N = 10;
string input_img_num = "/95_1";
string input_obj = "/circle";
...
int main(int argc, char **argv)
{
    ...
    while(true)
    {
        switch (Flag)
        {
            ...
            case 3:
                ...
                if(abs(theta_contact_2) > abs(theta_setup - theta_contact_1) || point_contact_2 == Point(0, 0))
                {
                    Flag = 4;
                    break;
                }
    ...
    imwrite(output_path + input_img_num + "_" + to_string(segment_N) + "_black" + ".jpg", img_black);
